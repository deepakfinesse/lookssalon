...
const Header = () => {
  ...
  return (
    <>
      ...
      <header
        className={`py-6 bg-white fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="relative flex justify-between items-center w-full">
            ...
            >
              ...
              <div className="h-1 bg-black rounded w-3/4 self-start transition-colors duration-300 group-hover:bg-primary"></div>
              <div className="h-1 bg-black rounded transition-colors duration-300 group-hover:bg-primary"></div>
            </div>
