          ...
          <div className="w-full md:pl-10">
            <form className="space-y-8">
              ...
              <div className="relative">
                ...
                >
                  <option value="" disabled hidden></option>
                  <option value="Hair" className="text-black">Hair</option>
                  <option value="Makeup" className="text-black">Makeup</option>
                  <option value="Skin" className="text-black">Skin</option>
                </select>
