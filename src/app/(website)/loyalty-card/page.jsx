  ...
  return (
    <>
            ...
            <div className="mx-auto max-w-7xl px-4">
              <div className='grid grid-cols-1 md:grid-cols-[4fr_6fr] items-center'>
                ...
                <div className='h-full flex flex-col justify-center items-left text-left'>
                  <FadeUp delay={0.1}>
                    <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-black font-bold uppercase mb-4 text-left">
                        lyl card & <br/> Benefits
                    </h2>
                  </FadeUp>
                  <FadeUp delay={0.2}>
                    <p className='text-md lg:text-lg text-black'>More than a membership. It's a lifestyle.</p>
                  </FadeUp>
                </div>
                <div className='h-full flex flex-col items-left text-left pt-5 md:pt-10'>
                  <img src="/img/loyalty/loyalty-card.webp" alt="Loyalty Card" className='w-full h-full object-cover' />
                </div>
              </div>
            </div>
        </section>
        ...
        <section className="w-full bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-[3.5fr_6.5fr] items-center gap-12 md:gap-16">

                {/* ── Card stack ── */}
                <FadeUp delay={0.1}>
                <div className="relative mx-auto">
                    <div className="absolute inset-0 flex items-center justify-center rounded-md bg-black shadow-2xl">
                    <img src="/img/loyalty/loyalty-card-lyl.webp" alt="Loyalty Card" className='' />
                    </div>
                </div>
                </FadeUp>
                ...
                <FadeUp delay={0.1}>
                    <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-5xl text-black font-bold uppercase mb-4 text-left">
                    Indulge. Save. Shine.
                    </h2>
                </FadeUp>
                ...
                <FadeUp delay={0.4}>
                    ...
                    {benefits.map((b) => (
                        <div
                        key={b.title}
                        className="group border p-4 border-neutral-300 hover:border-primary transition flex flex-col items-center justify-start text-center"
                        >
                        <p className="text-xl font-bold text-black group-hover:text-primary transition">
                            {b.title}
                        </p>
                        <p className="mt-1 text-md lg:text-lg text-black">{b.desc}</p>
                        </div>
                    ))}
                    </div>
                </FadeUp>
