...
export const metadata = {
  ...
  description: "Your franchise inquiry has been received. Our team will be in touch shortly.",
  robots:  "noindex",
};

export default function FranchiseThankYouPage({ searchParams }) {
    ...
    <main className="min-h-[calc(100vh-90px)] bg-black flex items-center justify-center px-4 py-12">
      ...
      <div className="relative w-full max-w-xl text-center">
        ...
        <p className="text-white/70 text-sm tracking-wide mb-6">
          Our franchise team will review your details and contact you shortly.
        </p>
