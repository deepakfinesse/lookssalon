        ...
        <div className="max-w-7xl mx-auto p-4 md:p-8  text-black">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-30  p-4">
            ...
            <div className="hidden md:block space-y-14">
              <div className="sticky top-[88px] overflow-hidden group">
                <Image
          ...
          <div className=" grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-30  md:p-4">
            ...
            <div className="hidden md:block flex flex-col justify-between">
                <div className="overflow-hidden group mt-4 md:p-1">
                  <Image src="/img/services/mens-four.webp" alt="" width={400} height={200} className="w-full transition-transform duration-500 group-hover:scale-110" />
                </div>
            </div>
          </div>
